...
#define ENGINE_PERIOD_MS     100 //milliseconds
...
int main() {
  ...
  Thread* th_txer = new Thread(sender,      50, SENDER_PERIOD_MS,   NULL, osPriorityHigh);
  Thread* th_rxer = new Thread(receiver,    50, RECEIVER_PERIOD_MS, NULL, osPriorityHigh);
